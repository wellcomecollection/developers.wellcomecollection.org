...
[View on GitHub](https://github.com/wellcomecollection/developers.wellcomecollection.org/tree/notebooks/notebooks/08-extracting-features-from-text.ipynb) | [Run in Google Colab](https://colab.research.google.com/github/wellcomecollection/developers.wellcomecollection.org/tree/notebooks/notebooks/08-extracting-features-from-text.ipynb)
