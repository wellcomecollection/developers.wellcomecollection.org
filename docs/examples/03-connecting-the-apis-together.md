...
[View on GitHub](https://github.com/wellcomecollection/developers.wellcomecollection.org/blob/add-all-id-endpoint/notebooks/03-connecting-the-apis-together.ipynb) | [Run in Google Colab](https://colab.research.google.com/github/wellcomecollection/developers.wellcomecollection.org/blob/add-all-id-endpoint/notebooks/03-connecting-the-apis-together.ipynb)
